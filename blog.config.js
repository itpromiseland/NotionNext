...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '经济学人狂热者', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '读完1000篇经济学人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'tewords.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '经济学人, 英语词汇, 雅思, 托福, GRE, 考研, 四级, 六级', // 网站关键词 英文逗号隔开
